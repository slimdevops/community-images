...
PROJECT_TARGET_IMAGE="$SLIM_IMAGE_NS/$REPOSITORY$TARGET_IMAGE_POSTFIX:$TAG"
PROJECT_IMAGE_INSTRUMENTED="$SLIM_IMAGE_NS/$REPOSITORY$TARGET_IMAGE_POSTFIX:$PROJECT_IMAGE_TAG_INSTRUMENTED"
PROJECT_IMAGE_SLIMMED="$SLIM_IMAGE_NS/$REPOSITORY$TARGET_IMAGE_POSTFIX:$PROJECT_IMAGE_TAG_SLIM"
