...
PROJECT_TARGET_IMAGE="$SLIM_IMAGE_NS/$REPOSITORY:$TAG"

PROJECT_IMAGE_INSTRUMENTED="$SLIM_IMAGE_NS/$REPOSITORY:$PROJECT_IMAGE_TAG_INSTRUMENTED"
PROJECT_IMAGE_SLIMMED="$SLIM_IMAGE_NS/$REPOSITORY:$PROJECT_IMAGE_TAG_SLIM"

PROJECT_FULL_IMAGE_FAT="$SLIM_IMAGE_NS/$REPOSITORY:$PROJECT_IMAGE_TAG_SLIM"
PROJECT_FULL_IMAGE_SLIMMED="$SLIM_IMAGE_NS/$REPOSITORY:$PROJECT_IMAGE_TAG_SLIM"
PROJECT_FULL_IMAGE_INSTRUMENTED="$SLIM_IMAGE_NS/$REPOSITORY:$PROJECT_IMAGE_TAG_INSTRUMENTED"
