...
<table id="status-base-image">
 ...
 <tr id="docker.io-jenkins-jenkins-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/4425515077"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">jenkins/jenkins:latest</td>
    <td class="project-last-update">2023-03-15T11:01:13.750Z</td>
    </tr>
</table>
