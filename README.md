...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-tomcat-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6044141684"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/tomcat:latest</td>
    <td class="project-last-update">2023-09-01T01:10:39.597Z</td>
    </tr>
...
<table id="status-base-image">
 ...
 <tr id="docker.io-jenkins-jenkins-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6014756921"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">jenkins/jenkins:latest</td>
    <td class="project-last-update">2023-08-29T16:17:01.863Z</td>
    </tr>
