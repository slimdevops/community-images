...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-nginx-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6491105960"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">library/nginx:latest</td>
    <td class="project-last-update">2023-10-12T04:07:14.287Z</td>
    </tr>
