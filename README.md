...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-node-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5825096338"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/node:latest</td>
    <td class="project-last-update">2023-08-10T19:11:18.100Z</td>
    </tr>
 ...
 <tr id="docker.io-library-groovy-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5861127853"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/groovy:latest</td>
    <td class="project-last-update">2023-08-14T22:17:28.693Z</td>
    </tr>
 ...
 <tr id="docker.io-library-clojure-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5862387382"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/clojure:latest</td>
    <td class="project-last-update">2023-08-15T01:11:19.589Z</td>
    </tr>
 ...
 <tr id="docker.io-library-nginx-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5873432143"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/nginx:latest</td>
    <td class="project-last-update">2023-08-16T01:08:41.261Z</td>
    </tr>
 ...
 <tr id="docker.io-library-tomcat-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5873434547"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/tomcat:latest</td>
    <td class="project-last-update">2023-08-16T01:10:47.072Z</td>
    </tr>
...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-wordpress-latest">
    ...
    <td class="project-last-update">2023-08-10T06:19:00.108Z</td>
    </tr>
 ...
 <tr id="docker.io-library-gradle-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5873433765"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/gradle:latest</td>
    <td class="project-last-update">2023-08-16T01:13:39.909Z</td>
 </tr>
