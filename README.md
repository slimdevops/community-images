...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-redis-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5693959533"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">library/redis:latest</td>
    <td class="project-last-update">2023-07-28T18:31:20.031Z</td>
    </tr>
