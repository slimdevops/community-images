...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-clojure-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/4740406702"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">library/clojure:latest</td>
    <td class="project-last-update">2023-04-19T06:57:22.698Z</td>
    </tr>
