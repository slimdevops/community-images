...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-tomcat-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6510497332"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/tomcat:latest</td>
    <td class="project-last-update">2023-10-13T16:12:03.842Z</td>
    </tr>
...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-maven-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6515459918"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">library/maven:latest</td>
    <td class="project-last-update">2023-10-14T04:11:32.456Z</td>
    </tr>
