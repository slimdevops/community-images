...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-node-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/4995760871"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/node:latest</td>
    <td class="project-last-update">2023-05-16T19:11:33.682Z</td>
    </tr>
 ...
 <tr id="docker.io-library-dart-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5008313934"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/dart:latest</td>
    <td class="project-last-update">2023-05-17T22:09:35.216Z</td>
    </tr>
 <tr id="docker.io-library-erlang-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/4997097972"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/erlang:latest</td>
    <td class="project-last-update">2023-05-16T22:13:28.870Z</td>
    </tr>
...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-wordpress-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/4998183461"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/wordpress:latest</td>
    <td class="project-last-update">2023-05-17T01:15:00.192Z</td>
    </tr>
