...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-perl-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5455055931"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/perl:latest</td>
    <td class="project-last-update">2023-07-04T13:11:00.756Z</td>
    </tr>
...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-redis-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5453434521"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/redis:latest</td>
    <td class="project-last-update">2023-07-04T10:26:07.439Z</td>
    </tr>
