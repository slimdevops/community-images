...
<table id="status-base-image">
 ...
 <tr id="docker.io-jenkins-jenkins-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/4425421530"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">jenkins/jenkins:latest</td>
    <td class="project-last-update">2023-03-15T10:47:08.724Z</td>
    </tr>
</table>
