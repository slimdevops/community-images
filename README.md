...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-redis-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5273642478"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">library/redis:latest</td>
    <td class="project-last-update">2023-06-15T03:28:46.176Z</td>
    </tr>
