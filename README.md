...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-gradle-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5891317286"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">library/gradle:latest</td>
    <td class="project-last-update">2023-08-17T13:08:40.485Z</td>
 </tr>
