...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-redis-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/7447489646"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/redis:latest</td>
    <td class="project-last-update">2024-01-08T12:51:01.404Z</td>
    </tr>
 ...
 <tr id="docker.io-focaloiddev-redis-7.2.6-docker-fix-rc1">
    ...
    <td class="project-last-update">2024-01-08T10:33:34.886Z</td>
    </tr>
</table>
