...
<table id="status-base-image">
 ...
 <tr id="docker.io-prom-prometheus-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6097497254"><img src="https://img.shields.io/badge/Build-Failing-red.svg" /></a></td>
    <td class="project-image">prom/prometheus:latest</td>
    <td class="project-last-update">2023-09-06T13:08:18.607Z</td>
    </tr>
