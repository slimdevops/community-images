...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-clojure-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5861128058"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/clojure:latest</td>
    <td class="project-last-update">2023-08-14T22:11:08.751Z</td>
    </tr>
...
<table id="status-base-image">
 ...
 <tr id="docker.io-library-gradle-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/5861128346"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/gradle:latest</td>
    <td class="project-last-update">2023-08-14T22:13:24.879Z</td>
 </tr>
