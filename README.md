...
<table id="status-hello-world">
 ...
 <tr id="docker.io-library-node-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6718313336"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/node:latest</td>
    <td class="project-last-update">2023-11-01T10:12:57.260Z</td>
    </tr>
 ...
 <tr id="docker.io-library-dart-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6715537428"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/dart:latest</td>
    <td class="project-last-update">2023-11-01T04:09:38.471Z</td>
    </tr>
 ...
 <tr id="docker.io-library-julia-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6723974636"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/julia:latest</td>
    <td class="project-last-update">2023-11-01T21:15:32.087Z</td>
    </tr>
...
<table id="status-base-image">
 ...
 <tr id="docker.io-grafana-grafana-latest-ubuntu">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6629527013"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">grafana/grafana:latest-ubuntu</td>
    <td class="project-last-update">2023-10-24T22:10:14.439Z</td>
    </tr>
 ...
 <tr id="docker.io-library-wordpress-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6793617089"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">library/wordpress:latest</td>
    <td class="project-last-update">2023-11-08T09:16:52.341Z</td>
    </tr>
 ...
 <tr id="docker.io-jenkins-jenkins-latest">
    ...
    <td class="project-status"><a href="https://github.com/slimdevops/community-images/actions/runs/6787144167"><img src="https://img.shields.io/badge/Build-Passing-green.svg" /></a></td>
    <td class="project-image">jenkins/jenkins:latest</td>
    <td class="project-last-update">2023-11-07T16:15:48.402Z</td>
    </tr>
