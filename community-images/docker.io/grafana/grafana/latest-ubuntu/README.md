...
This community image example automatically hardens your application for production, reducing the size from 401 MB to 172 MB and removes 17 vulnerabilities along the way. 
