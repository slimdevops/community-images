...
This community image example automatically hardens your application for production, reducing the size from 456 MB to 219 MB and removes 10 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 456 MB | 219 MB | 51.00 | 
| File Count | 11661 | 833 | 92.00 | 
| Vulnerabilities | 15 | 5 | 66.00 | 
