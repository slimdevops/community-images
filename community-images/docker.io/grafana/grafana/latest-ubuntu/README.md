...
This community image example automatically hardens your application for production, reducing the size from 456 MB to 221 MB and removes 11 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 456 MB | 221 MB | 51.00 | 
| File Count | 11627 | 826 | 92.00 | 
| Vulnerabilities | 20 | 9 | 55.00 | 
