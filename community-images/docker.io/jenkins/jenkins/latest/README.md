...
This community image example automatically hardens your application for production, reducing the size from 476 MB to 201 MB and removes 57 vulnerabilities along the way. 
