...
This community image example automatically hardens your application for production, reducing the size from 462 MB to 201 MB and removes 63 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the jenkins/jenkins image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 462 MB | 201 MB | 56.00 | 
| File Count | 9350 | 727 | 92.00 | 
| Vulnerabilities | 85 | 22 | 74.00 | 
| Critical Vulnerabilities | 3 | 4 | 
| High Vulnerabilities | 13 | 5 | 
