...
This community image example automatically hardens your application for production, reducing the size from 483 MB to 201 MB and removes 58 vulnerabilities along the way. 
