...
This community image example automatically hardens your application for production, reducing the size from 474 MB to 201 MB and removes 64 vulnerabilities along the way. 
