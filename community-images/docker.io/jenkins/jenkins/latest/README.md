...
This community image example automatically hardens your application for production, reducing the size from 476 MB to 200 MB and removes 52 vulnerabilities along the way. 
