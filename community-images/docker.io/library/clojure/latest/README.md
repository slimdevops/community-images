...
This community image example automatically hardens your application for production, reducing the size from 595 MB to 209 MB and removes 28 vulnerabilities along the way. 
