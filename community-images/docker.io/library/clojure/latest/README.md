...
This community image example automatically hardens your application for production, reducing the size from 620 MB to 221 MB and removes 61 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 620 MB | 221 MB | 64.00 | 
| File Count | 10698 | 634 | 94.00 | 
| Vulnerabilities | 73 | 12 | 83.00 | 
