...
This community image example automatically hardens your application for production, reducing the size from 625 MB to 221 MB and removes 64 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/clojure image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 625 MB | 221 MB | 64.00 | 
| File Count | 10700 | 634 | 94.00 | 
| Vulnerabilities | 78 | 14 | 82.00 | 
| Critical Vulnerabilities | 1 | 0 | 
| High Vulnerabilities | 10 | 2 | 
