...
This community image example automatically hardens your application for production, reducing the size from 546 MB to 209 MB and removes 32 vulnerabilities along the way. 
