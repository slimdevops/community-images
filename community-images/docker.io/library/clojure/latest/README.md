...
This community image example automatically hardens your application for production, reducing the size from 623 MB to 221 MB and removes 67 vulnerabilities along the way. 
