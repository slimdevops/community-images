...
This community image example automatically hardens your application for production, reducing the size from 620 MB to 221 MB and removes 60 vulnerabilities along the way. 
