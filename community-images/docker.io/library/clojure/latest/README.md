...
This community image example automatically hardens your application for production, reducing the size from 602 MB to 209 MB and removes 31 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 602 MB | 209 MB | 65.00 | 
| File Count | 9676 | 631 | 93.00 | 
| Vulnerabilities | 34 | 3 | 91.00 | 
