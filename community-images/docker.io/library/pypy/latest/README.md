...
This community image example automatically hardens your application for production, reducing the size from 1000 MB to 98 MB and removes 465 vulnerabilities along the way. 
...
| Vulnerabilities | 482 | 17 | 96.00 | 
| Critical Vulnerabilities | 7 | 0 | 
| High Vulnerabilities | 111 | 1 | 
