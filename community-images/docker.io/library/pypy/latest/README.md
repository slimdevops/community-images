...
This community image example automatically hardens your application for production, reducing the size from 1.0 GB to 101 MB and removes 419 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/pypy image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 1.0 GB | 101 MB | 89.00 | 
| File Count | 27235 | 1466 | 94.00 | 
| Vulnerabilities | 435 | 16 | 96.00 | 
| Critical Vulnerabilities | 7 | 1 | 
| High Vulnerabilities | 77 | 0 | 
