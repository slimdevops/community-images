...
This community image example automatically hardens your application for production, reducing the size from 1.0 GB to 101 MB and removes 403 vulnerabilities along the way. 
