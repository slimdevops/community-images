...
This community image example automatically hardens your application for production, reducing the size from 130 MB to 35 MB and removes Unknown vulnerabilities along the way. 
