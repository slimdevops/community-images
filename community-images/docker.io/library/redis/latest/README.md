...
This community image example automatically hardens your application for production, reducing the size from 138 MB to 39 MB and removes 115 vulnerabilities along the way. 
