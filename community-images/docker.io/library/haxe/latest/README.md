...
This community image example automatically hardens your application for production, reducing the size from 352 MB to 15 MB and removes 121 vulnerabilities along the way. 
