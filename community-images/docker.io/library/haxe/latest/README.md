...
This community image example automatically hardens your application for production, reducing the size from 368 MB to 15 MB and removes 105 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 368 MB | 15 MB | 95.00 | 
| File Count | 14881 | 547 | 96.00 | 
