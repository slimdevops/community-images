...
This community image example automatically hardens your application for production, reducing the size from 365 MB to 15 MB and removes 105 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 365 MB | 15 MB | 95.00 | 
| File Count | 14846 | 547 | 96.00 | 
| Vulnerabilities | 112 | 7 | 93.00 | 
