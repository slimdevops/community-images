...
This community image example automatically hardens your application for production, reducing the size from 352 MB to 4.7 MB and removes 97 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 352 MB | 4.7 MB | 98.00 | 
| File Count | 14488 | 141 | 99.00 | 
| Vulnerabilities | 97 | 0 | 100.00 | 
