...
This community image example automatically hardens your application for production, reducing the size from 353 MB to 15 MB and removes 100 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 353 MB | 15 MB | 95.00 | 
| File Count | 14556 | 547 | 96.00 | 
| Vulnerabilities | 107 | 7 | 93.00 | 
