...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 79 MB and removes Unknown vulnerabilities along the way. 
