...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 63 MB and removes 343 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/erlang image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 1.5 GB | 63 MB | 95.00 | 
| File Count | 38180 | 246 | 99.00 | 
| Vulnerabilities | 343 | 0 | 100.00 | 
| Critical Vulnerabilities | 14 | 0 | 
| High Vulnerabilities | 122 | 0 | 


You can check out the [new container image](https://portal.slim.dev/home/xray/dockerhub:%2F%2Fdockerhub.public%2Fslimdevops%2Ferlang:latest.slimxx#explorer) for yourself on the Slim Platform (free registration required). 
