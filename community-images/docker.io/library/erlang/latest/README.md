...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 79 MB and removes 390 vulnerabilities along the way. 
...
| Vulnerabilities | 403 | 13 | 96.00 | 
| Critical Vulnerabilities | 4 | 1 | 
| High Vulnerabilities | 63 | 0 | 
