...
This community image example automatically hardens your application for production, reducing the size from 988 MB to 36 MB and removes 257 vulnerabilities along the way. 
