...
This community image example automatically hardens your application for production, reducing the size from 987 MB to 36 MB and removes 241 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 987 MB | 36 MB | 96.00 | 
| File Count | 25345 | 720 | 97.00 | 
| Vulnerabilities | 254 | 13 | 94.00 | 
