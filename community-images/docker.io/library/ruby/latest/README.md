...
This community image example automatically hardens your application for production, reducing the size from 990 MB to 36 MB and removes 263 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 990 MB | 36 MB | 96.00 | 
| File Count | 25490 | 720 | 97.00 | 
| Vulnerabilities | 274 | 11 | 95.00 | 
