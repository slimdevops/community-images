...
This community image example automatically hardens your application for production, reducing the size from 906 MB to 36 MB and removes 330 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 906 MB | 36 MB | 96.00 | 
| File Count | 24908 | 714 | 97.00 | 
| Vulnerabilities | 341 | 11 | 96.00 | 
