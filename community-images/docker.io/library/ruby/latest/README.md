...
This community image example automatically hardens your application for production, reducing the size from 989 MB to 36 MB and removes 268 vulnerabilities along the way. 
