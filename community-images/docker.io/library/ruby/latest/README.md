...
This community image example automatically hardens your application for production, reducing the size from 892 MB to 36 MB and removes 336 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 892 MB | 36 MB | 95.00 | 
| File Count | 24601 | 714 | 97.00 | 
| Vulnerabilities | 347 | 11 | 96.00 | 
