...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 84 MB and removes 332 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 1.5 GB | 84 MB | 94.00 | 
| File Count | 39552 | 1331 | 96.00 | 
| Vulnerabilities | 350 | 18 | 94.00 | 
| Critical Vulnerabilities | 13 | 1 | 
| High Vulnerabilities | 126 | 8 | 
