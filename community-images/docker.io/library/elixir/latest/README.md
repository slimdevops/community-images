...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 88 MB and removes 380 vulnerabilities along the way. 
