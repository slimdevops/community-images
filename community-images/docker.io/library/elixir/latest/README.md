...
This community image example automatically hardens your application for production, reducing the size from 1.6 GB to 84 MB and removes 334 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 1.6 GB | 84 MB | 94.00 | 
| File Count | 39854 | 1331 | 96.00 | 
| Vulnerabilities | 354 | 20 | 94.00 | 
