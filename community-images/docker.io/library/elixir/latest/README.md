...
This community image example automatically hardens your application for production, reducing the size from 1.6 GB to 89 MB and removes 410 vulnerabilities along the way. 
