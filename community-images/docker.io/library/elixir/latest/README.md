...
This community image example automatically hardens your application for production, reducing the size from 1.6 GB to 88 MB and removes 381 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 1.6 GB | 88 MB | 94.00 | 
| File Count | 39630 | 1343 | 96.00 | 
| Vulnerabilities | 398 | 17 | 95.00 | 
