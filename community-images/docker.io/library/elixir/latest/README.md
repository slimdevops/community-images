...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 88 MB and removes 388 vulnerabilities along the way. 
...
| Vulnerabilities | 406 | 18 | 95.00 | 
| Critical Vulnerabilities | 6 | 0 | 
| High Vulnerabilities | 76 | 1 | 
