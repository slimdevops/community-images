...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 89 MB and removes 383 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 1.5 GB | 89 MB | 94.00 | 
| File Count | 39600 | 1352 | 96.00 | 
| Vulnerabilities | 403 | 20 | 95.00 | 
