...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 88 MB and removes 393 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 1.5 GB | 88 MB | 94.00 | 
| File Count | 39597 | 1352 | 96.00 | 
| Vulnerabilities | 416 | 23 | 94.00 | 
| Critical Vulnerabilities | 4 | 0 | 
| High Vulnerabilities | 68 | 2 | 
