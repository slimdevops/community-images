...
This community image example automatically hardens your application for production, reducing the size from 757 MB to 336 MB and removes 28 vulnerabilities along the way. 
