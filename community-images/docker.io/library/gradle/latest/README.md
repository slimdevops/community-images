...
This community image example automatically hardens your application for production, reducing the size from 713 MB to 339 MB and removes 69 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 713 MB | 339 MB | 52.00 | 
| File Count | 11602 | 882 | 92.00 | 
