...
This community image example automatically hardens your application for production, reducing the size from 712 MB to 339 MB and removes Unknown vulnerabilities along the way. 
