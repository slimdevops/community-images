...
Looking to ship library/gradle to production in a secure way without spending hours wrestling with your Dockerfiles? 

This community image example automatically hardens your application for production, reducing the size from 757 MB to 336 MB and removes 26 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/gradle image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 757 MB | 336 MB | 55.00 | 
| File Count | 11565 | 871 | 92.00 | 
| Vulnerabilities | 48 | 22 | 54.00 | 
| Critical Vulnerabilities | 3 | 3 | 
| High Vulnerabilities | 14 | 14 | 


You can check out the [new container image](https://portal.slim.dev/home/xray/dockerhub:%2F%2Fdockerhub.public%2Fslimdevops%2Fgradle:latest.slimxx#explorer) for yourself on the Slim Platform (free registration required). 
