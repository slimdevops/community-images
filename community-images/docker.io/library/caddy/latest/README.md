...
Looking to ship library/caddy to production in a secure way without spending hours wrestling with your Dockerfiles? 
...
The process starts by building an containerized application based off of the library/caddy image, and then runs it against its test suite found in the project folder.
