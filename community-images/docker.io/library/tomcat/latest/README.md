...
This community image example automatically hardens your application for production, reducing the size from 472 MB to 241 MB and removes Unknown vulnerabilities along the way. 
