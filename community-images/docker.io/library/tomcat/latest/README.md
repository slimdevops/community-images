...
This community image example automatically hardens your application for production, reducing the size from 500 MB to 225 MB and removes 15 vulnerabilities along the way. 
