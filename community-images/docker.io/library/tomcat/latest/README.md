...
This community image example automatically hardens your application for production, reducing the size from 474 MB to 241 MB and removes 13 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/tomcat image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 474 MB | 241 MB | 49.00 | 
| File Count | 6207 | 670 | 89.00 | 
| Vulnerabilities | 47 | 34 | 27.00 | 
