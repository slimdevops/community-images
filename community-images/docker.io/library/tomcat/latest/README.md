...
This community image example automatically hardens your application for production, reducing the size from 444 MB to 225 MB and removes 20 vulnerabilities along the way. 
