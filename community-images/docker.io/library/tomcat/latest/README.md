...
This community image example automatically hardens your application for production, reducing the size from 444 MB to 226 MB and removes 15 vulnerabilities along the way. 
