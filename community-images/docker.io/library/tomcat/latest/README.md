...
This community image example automatically hardens your application for production, reducing the size from 493 MB to 225 MB and removes 17 vulnerabilities along the way. 
