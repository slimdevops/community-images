...
This community image example automatically hardens your application for production, reducing the size from 492 MB to 213 MB and removes 15 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 492 MB | 213 MB | 56.00 | 
| File Count | 5885 | 222 | 96.00 | 
| Vulnerabilities | 18 | 3 | 83.00 | 
