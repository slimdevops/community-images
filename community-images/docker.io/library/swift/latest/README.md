...
This community image example automatically hardens your application for production, reducing the size from 2.6 GB to 38 MB and removes 122 vulnerabilities along the way. 
