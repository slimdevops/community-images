...
This community image example automatically hardens your application for production, reducing the size from 2.7 GB to 38 MB and removes Unknown vulnerabilities along the way. 
