...
This community image example automatically hardens your application for production, reducing the size from 499 MB to 217 MB and removes Unknown vulnerabilities along the way. 
