...
This community image example automatically hardens your application for production, reducing the size from 549 MB to 269 MB and removes 16 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 549 MB | 269 MB | 51.00 | 
| File Count | 7452 | 705 | 90.00 | 
| Vulnerabilities | 20 | 4 | 80.00 | 
