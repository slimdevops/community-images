...
This community image example automatically hardens your application for production, reducing the size from 509 MB to 222 MB and removes 31 vulnerabilities along the way. 
