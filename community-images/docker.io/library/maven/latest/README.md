...
This community image example automatically hardens your application for production, reducing the size from 550 MB to 269 MB and removes 20 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 550 MB | 269 MB | 51.00 | 
| File Count | 7108 | 705 | 90.00 | 
| Vulnerabilities | 24 | 4 | 83.00 | 
