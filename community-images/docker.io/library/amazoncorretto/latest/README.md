...
This community image example automatically hardens your application for production, reducing the size from 349 MB to 210 MB and removes 1 vulnerabilities along the way. 
