...
Looking to ship library/amazoncorretto to production in a secure way without spending hours wrestling with your Dockerfiles? 

This community image example automatically hardens your application for production, reducing the size from 349 MB to 210 MB and removes -24 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/amazoncorretto image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 349 MB | 210 MB | 39.00 | 
| File Count | 6804 | 2885 | 57.00 | 
| Vulnerabilities | 1 | 25 | -2400.00 | 
| Critical Vulnerabilities | 0 | 0 | 
| High Vulnerabilities | 1 | 2 | 


You can check out the [new container image](https://portal.slim.dev/home/xray/dockerhub:%2F%2Fdockerhub.public%2Fslimdevops%2Famazoncorretto:latest.slimxx#explorer) for yourself on the Slim Platform (free registration required). 
