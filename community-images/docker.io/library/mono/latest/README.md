...
This community image example automatically hardens your application for production, reducing the size from 788 MB to 51 MB and removes 223 vulnerabilities along the way. 
