...
This community image example automatically hardens your application for production, reducing the size from 230 MB to 211 MB and removes Unknown vulnerabilities along the way. 
