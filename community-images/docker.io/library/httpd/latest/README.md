...
Looking to ship library/httpd to production in a secure way without spending hours wrestling with your Dockerfiles? 

This community image example automatically hardens your application for production, reducing the size from 168 MB to 20 MB and removes 129 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/httpd image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 168 MB | 20 MB | 88.00 | 
| File Count | 5827 | 575 | 90.00 | 
| Vulnerabilities | 145 | 16 | 88.00 | 
| Critical Vulnerabilities | 0 | 0 | 
| High Vulnerabilities | 17 | 3 | 


You can check out the [new container image](https://portal.slim.dev/home/xray/dockerhub:%2F%2Fdockerhub.public%2Fslimdevops%2Fhttpd:latest.slimxx#explorer) for yourself on the Slim Platform (free registration required). 
