...
This community image example automatically hardens your application for production, reducing the size from 145 MB to 8.7 MB and removes 57 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 145 MB | 8.7 MB | 94.00 | 
| File Count | 4457 | 180 | 95.00 | 
| Vulnerabilities | 57 | 0 | 100.00 | 
