...
This community image example automatically hardens your application for production, reducing the size from 299 MB to 128 MB and removes 94 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 299 MB | 128 MB | 57.00 | 
| File Count | 8797 | 387 | 95.00 | 
| Vulnerabilities | 108 | 14 | 87.00 | 
| Critical Vulnerabilities | 1 | 1 | 
| High Vulnerabilities | 40 | 7 | 
