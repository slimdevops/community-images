...
This community image example automatically hardens your application for production, reducing the size from 299 MB to 139 MB and removes 108 vulnerabilities along the way. 
