...
This community image example automatically hardens your application for production, reducing the size from 300 MB to 139 MB and removes 106 vulnerabilities along the way. 
