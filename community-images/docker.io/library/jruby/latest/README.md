...
This community image example automatically hardens your application for production, reducing the size from 304 MB to 140 MB and removes 97 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 304 MB | 140 MB | 53.00 | 
| File Count | 9124 | 815 | 91.00 | 
| Vulnerabilities | 103 | 6 | 94.00 | 
