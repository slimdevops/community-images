...
This community image example automatically hardens your application for production, reducing the size from 300 MB to 139 MB and removes 116 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 300 MB | 139 MB | 53.00 | 
| File Count | 9096 | 803 | 91.00 | 
| Vulnerabilities | 120 | 4 | 96.00 | 
