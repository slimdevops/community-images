...
This community image example automatically hardens your application for production, reducing the size from 529 MB to 92 MB and removes 130 vulnerabilities along the way. 
