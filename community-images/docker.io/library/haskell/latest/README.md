...
This community image example automatically hardens your application for production, reducing the size from 4.3 GB to 54 MB and removes 483 vulnerabilities along the way. 
