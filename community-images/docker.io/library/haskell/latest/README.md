...
This community image example automatically hardens your application for production, reducing the size from 4.8 GB to 30 MB and removes 532 vulnerabilities along the way. 
