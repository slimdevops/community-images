...
This community image example automatically hardens your application for production, reducing the size from 5.0 GB to 31 MB and removes 547 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 5.0 GB | 31 MB | 99.00 | 
| File Count | 36541 | 601 | 98.00 | 
| Vulnerabilities | 561 | 14 | 97.00 | 
