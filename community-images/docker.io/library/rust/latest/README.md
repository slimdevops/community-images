...
This community image example automatically hardens your application for production, reducing the size from 1.5 GB to 19 MB and removes 241 vulnerabilities along the way. 
