...
This community image example automatically hardens your application for production, reducing the size from 187 MB to 24 MB and removes 50 vulnerabilities along the way. 
