...
This community image example automatically hardens your application for production, reducing the size from 187 MB to 24 MB and removes 52 vulnerabilities along the way. 
...
| File Count | 4299 | 595 | 86.00 | 
| Vulnerabilities | 69 | 17 | 75.00 | 
