...
This community image example automatically hardens your application for production, reducing the size from 187 MB to 24 MB and removes 64 vulnerabilities along the way. 
...
| File Count | 4207 | 595 | 85.00 | 
| Vulnerabilities | 82 | 18 | 78.00 | 
