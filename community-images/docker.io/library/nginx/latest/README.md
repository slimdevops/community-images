...
This community image example automatically hardens your application for production, reducing the size from 142 MB to 23 MB and removes 72 vulnerabilities along the way. 
