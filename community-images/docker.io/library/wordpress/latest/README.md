...
This community image example automatically hardens your application for production, reducing the size from 666 MB to 206 MB and removes 214 vulnerabilities along the way. 
