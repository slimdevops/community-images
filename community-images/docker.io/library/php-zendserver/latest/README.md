...
This community image example automatically hardens your application for production, reducing the size from 1.0 GB to 339 MB and removes 42 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/php-zendserver image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 1.0 GB | 339 MB | 66.00 | 
| File Count | 17552 | 1650 | 90.00 | 
| Vulnerabilities | 42 | 0 | 100.00 | 
| Critical Vulnerabilities | 6 | 0 | 
| High Vulnerabilities | 20 | 0 | 
