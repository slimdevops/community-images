...
This community image example automatically hardens your application for production, reducing the size from 1.0 GB to 12 MB and removes 43 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 1.0 GB | 12 MB | 98.00 | 
| File Count | 17552 | 385 | 97.00 | 
| Vulnerabilities | 47 | 4 | 91.00 | 
| Critical Vulnerabilities | 6 | 0 | 
| High Vulnerabilities | 20 | 2 | 
