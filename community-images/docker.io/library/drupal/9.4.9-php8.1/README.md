...
Looking to ship library/drupal to production in a secure way without spending hours wrestling with your Dockerfiles? 

This community image example automatically hardens your application for production, reducing the size from 558 MB to 184 MB and removes 218 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/drupal image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 558 MB | 184 MB | 66.00 | 
| File Count | 31180 | 22087 | 29.00 | 
| Vulnerabilities | 307 | 89 | 71.00 | 
| Critical Vulnerabilities | 8 | 7 | 
| High Vulnerabilities | 60 | 19 | 


You can check out the [new container image](https://portal.slim.dev/home/xray/dockerhub:%2F%2Fdockerhub.public%2Fslimdevops%2Fdrupal:9.4.9-php8.1.slimxx#explorer) for yourself on the Slim Platform (free registration required). 
