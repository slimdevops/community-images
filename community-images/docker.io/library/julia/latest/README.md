...
This community image example automatically hardens your application for production, reducing the size from 607 MB to 491 MB and removes 24 vulnerabilities along the way. 
