...
This community image example automatically hardens your application for production, reducing the size from 553 MB to 443 MB and removes 51 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 553 MB | 443 MB | 19.00 | 
| File Count | 5750 | 667 | 88.00 | 
| Vulnerabilities | 58 | 7 | 87.00 | 
