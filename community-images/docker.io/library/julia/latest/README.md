...
This community image example automatically hardens your application for production, reducing the size from 686 MB to 491 MB and removes 38 vulnerabilities along the way. 
