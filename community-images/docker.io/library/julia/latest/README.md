...
This community image example automatically hardens your application for production, reducing the size from 685 MB to 491 MB and removes 40 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 685 MB | 491 MB | 28.00 | 
| File Count | 5502 | 679 | 87.00 | 
| Vulnerabilities | 52 | 12 | 76.00 | 
