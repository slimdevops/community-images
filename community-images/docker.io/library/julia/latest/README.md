...
This community image example automatically hardens your application for production, reducing the size from 553 MB to 433 MB and removes 52 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 553 MB | 433 MB | 21.00 | 
| File Count | 5749 | 287 | 95.00 | 
| Vulnerabilities | 52 | 0 | 100.00 | 
