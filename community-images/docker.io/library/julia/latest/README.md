...
This community image example automatically hardens your application for production, reducing the size from 604 MB to 492 MB and removes 58 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/julia image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 604 MB | 492 MB | 18.00 | 
| File Count | 5661 | 683 | 87.00 | 
| Vulnerabilities | 65 | 7 | 89.00 | 
| Critical Vulnerabilities | 3 | 0 | 
| High Vulnerabilities | 13 | 0 | 
