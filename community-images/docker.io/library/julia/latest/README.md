...
This community image example automatically hardens your application for production, reducing the size from 607 MB to 492 MB and removes 27 vulnerabilities along the way. 
