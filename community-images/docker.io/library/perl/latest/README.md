...
This community image example automatically hardens your application for production, reducing the size from 990 MB to 19 MB and removes 242 vulnerabilities along the way. 
