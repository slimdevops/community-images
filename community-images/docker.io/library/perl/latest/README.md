...
This community image example automatically hardens your application for production, reducing the size from 907 MB to 19 MB and removes 333 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 907 MB | 19 MB | 97.00 | 
| File Count | 24360 | 585 | 97.00 | 
