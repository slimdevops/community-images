...
This community image example automatically hardens your application for production, reducing the size from 1.2 GB to 25 MB and removes 235 vulnerabilities along the way. 
...
| Vulnerabilities | 257 | 22 | 91.00 | 
| Critical Vulnerabilities | 7 | 0 | 
| High Vulnerabilities | 55 | 4 | 
