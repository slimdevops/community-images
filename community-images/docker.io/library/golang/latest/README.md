...
This community image example automatically hardens your application for production, reducing the size from 1.2 GB to 25 MB and removes 269 vulnerabilities along the way. 
...
| Vulnerabilities | 293 | 24 | 91.00 | 
| Critical Vulnerabilities | 5 | 0 | 
| High Vulnerabilities | 72 | 4 | 
