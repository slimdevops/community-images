...
This community image example automatically hardens your application for production, reducing the size from 1.2 GB to 25 MB and removes 283 vulnerabilities along the way. 
...
| Vulnerabilities | 307 | 24 | 92.00 | 
| Critical Vulnerabilities | 6 | 0 | 
| High Vulnerabilities | 76 | 4 | 
