...
This community image example automatically hardens your application for production, reducing the size from 1.2 GB to 25 MB and removes 254 vulnerabilities along the way. 
...
| Vulnerabilities | 278 | 24 | 91.00 | 
| Critical Vulnerabilities | 7 | 0 | 
| High Vulnerabilities | 62 | 4 | 
