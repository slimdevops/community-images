...
This community image example automatically hardens your application for production, reducing the size from 1.2 GB to 25 MB and removes 225 vulnerabilities along the way. 
