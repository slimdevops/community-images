...
This community image example automatically hardens your application for production, reducing the size from 1.2 GB to 25 MB and removes 294 vulnerabilities along the way. 
...
| Vulnerabilities | 327 | 33 | 89.00 | 
| Critical Vulnerabilities | 6 | 0 | 
| High Vulnerabilities | 78 | 9 | 
