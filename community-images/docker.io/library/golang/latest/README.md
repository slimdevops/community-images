...
This community image example automatically hardens your application for production, reducing the size from 1.2 GB to 25 MB and removes 274 vulnerabilities along the way. 
...
| Vulnerabilities | 298 | 24 | 91.00 | 
| Critical Vulnerabilities | 5 | 0 | 
| High Vulnerabilities | 74 | 4 | 
