...
This community image example automatically hardens your application for production, reducing the size from 1.2 GB to 25 MB and removes 270 vulnerabilities along the way. 
...
| Vulnerabilities | 294 | 24 | 91.00 | 
| Critical Vulnerabilities | 5 | 0 | 
| High Vulnerabilities | 73 | 4 | 
