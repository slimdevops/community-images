...
This community image example automatically hardens your application for production, reducing the size from 998 MB to 111 MB and removes 345 vulnerabilities along the way. 
