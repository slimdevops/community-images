...
This community image example automatically hardens your application for production, reducing the size from 1.0 GB to 113 MB and removes 334 vulnerabilities along the way. 
