...
This community image example automatically hardens your application for production, reducing the size from 1.0 GB to 113 MB and removes 332 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 1.0 GB | 113 MB | 88.00 | 
| File Count | 26961 | 600 | 97.00 | 
| Vulnerabilities | 344 | 12 | 96.00 | 
