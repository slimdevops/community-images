...
This community image example automatically hardens your application for production, reducing the size from 1.0 GB to 114 MB and removes Unknown vulnerabilities along the way. 
