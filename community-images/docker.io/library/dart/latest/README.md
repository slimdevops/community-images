...
Looking to ship library/dart to production in a secure way without spending hours wrestling with your Dockerfiles? 

This community image example automatically hardens your application for production, reducing the size from 9.9 MB to 9.9 MB and removes 0 vulnerabilities along the way. 
...
The process starts by building an containerized application based off of the library/dart image, and then runs it against its test suite found in the project folder.
...
| ---| --- | --- | --- | 
| Size | 9.9 MB | 9.9 MB | 0.00 | 
| File Count | 151 | 147 | 2.00 | 
| Vulnerabilities | 0 | 0 | 0.00 | 
| Critical Vulnerabilities | 0 | 0 | 
| High Vulnerabilities | 0 | 0 | 


You can check out the [new container image](https://portal.slim.dev/home/xray/dockerhub:%2F%2Fdockerhub.public%2Fslimdevops%2Fdart:latest.slimxx#explorer) for yourself on the Slim Platform (free registration required). 
