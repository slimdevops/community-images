...
This community image example automatically hardens your application for production, reducing the size from 10 MB to 10 MB and removes Unknown vulnerabilities along the way. 
