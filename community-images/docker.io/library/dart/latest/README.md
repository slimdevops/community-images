...
This community image example automatically hardens your application for production, reducing the size from 11 MB to 11 MB and removes 0 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 11 MB | 11 MB | 1.00 | 
| File Count | 140 | 136 | 2.00 | 
