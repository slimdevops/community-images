...
This community image example automatically hardens your application for production, reducing the size from 247 MB to 125 MB and removes 0 vulnerabilities along the way. 
