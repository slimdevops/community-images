...
This community image example automatically hardens your application for production, reducing the size from 234 MB to 119 MB and removes 0 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 234 MB | 119 MB | 49.00 | 
| File Count | 803 | 6 | 99.00 | 
| Vulnerabilities | 3 | 3 | 0.00 | 
