...
This community image example automatically hardens your application for production, reducing the size from 245 MB to 124 MB and removes 0 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 245 MB | 124 MB | 49.00 | 
| File Count | 925 | 6 | 99.00 | 
