...
This community image example automatically hardens your application for production, reducing the size from 234 MB to 120 MB and removes 0 vulnerabilities along the way. 
...
| ---| --- | --- | --- | 
| Size | 234 MB | 120 MB | 48.00 | 
| File Count | 803 | 6 | 99.00 | 
| Vulnerabilities | 7 | 7 | 0.00 | 
